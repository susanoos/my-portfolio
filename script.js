...
const projects = [
  ...
  {
    title: "Bankist",
    description: `Taught in the JavaScript course I took in Udemy, it was used as a tutorial to implament various features which are frequently used today.`,
      ...
      <div class="project">
        <h2 class="project-title">${project.title}</h2>
          ...
          <div class="project-links">
            <a href="live-demo-link" target="_blank">Demo: ${project.liveDemo}</a>
